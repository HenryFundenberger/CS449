...
class App(tk.Tk):
    ...
    def create_widgets(self):
       ...
       #Create label in center of window
        ...
        self.player1_x = tk.Radiobutton(self.controls_frame, text="X", variable=self.player1_var, value="X")
        ...
        self.player2_x = tk.Radiobutton(self.controls_frame, text="X", variable=self.player2_var, value="X")
